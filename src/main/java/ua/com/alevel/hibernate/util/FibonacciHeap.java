 ...
 *
 * <p>Modified from
 * <a href="https://www.keithschwarz.com/interesting/code/?dir=fibonacci-heap">www.keithschwarz.com/interesting/code/?dir=fibonacci-heap</a>
 *
 * <p>
 ...
 * we can implement delete by decreasing a key to -Integer.MAX_VALUE, then calling
...
public final class FibonacciHeap<T> {
    ...
    public Entry<T> dequeueMin() {
         ...
         */
        ArrayList<Entry<T>> treeTable = new ArrayList<>();
         ...
         */
        ArrayList<Entry<T>> toVisit = new ArrayList<>();
        ...
        for (Entry<T> curr : toVisit) {
            ...
            while (true) {
                 ...
                 * degree.
                 */
                treeTable.ensureCapacity(curr.mDegree + 1);
                ...
                /* Otherwise, merge with what's there and clear the slot */
                Entry<T> other = treeTable.set(curr.mDegree, null);
                ...
                Entry<T> min;
                Entry<T> max;
                if (other.mPriority < curr.mPriority) {
                    min = other;
                    max = curr;
                } else {
                    min = curr;
    ...
    public void delete(Entry<T> entry) {
        /* Use decreaseKey to drop the entry's key to Integer.MIN_VALUE.  This will
    ...
    private void decreaseKeyUnchecked(Entry<T> entry, int priority) {
         ...
         * that decreases the key to Integer.MIN_VALUE, it's guaranteed to cut the node
         * from its parent.
         */
